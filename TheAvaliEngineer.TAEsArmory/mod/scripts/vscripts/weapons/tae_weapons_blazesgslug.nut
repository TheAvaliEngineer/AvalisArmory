#if SERVER
global function ThermiteSlugBurn
global const float THERMITE_SLUG_BURN_TIME = 2.5
global const float THERMITE_SLUG_BURN_ITER = 0.1
#endif

global function OnProjectileCollision_weapon_blazeSgSlug
global function OnProjectileIgnite_weapon_blazeSgSlug

// Copied from mp_weapon_thermite_grenade since it's functionally identical
void function OnProjectileCollision_weapon_blazeSgSlug( entity projectile, vector pos, vector normal, entity hitEnt, int hitbox, bool isCritical ) {
...
// Copied from mp_weapon_thermite_grenade since it's functionally identical
void function OnProjectileIgnite_weapon_blazeSgSlug( entity projectile ) {
	projectile.SetDoesExplode( false )
		...
		thread ThermiteBurn( THERMITE_SLUG_BURN_TIME, player, projectile )
...
// Thermite burn & check from mp_weapon_thermite_grenade, copied & renamed

#if SERVER
	void function ThermiteSlugBurn( float burnTime, entity owner, entity projectile, entity vortexSphere = null ) {
